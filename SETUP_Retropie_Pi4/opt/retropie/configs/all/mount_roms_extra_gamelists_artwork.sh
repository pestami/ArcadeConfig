...
#=========================================================
for rom_folder in atari2600 atari5200 atari7800 arcade mame-libretro mame-mame4all neogeo mastersystems megadrive sg-1000 nes snes gba gc ports pc c64 pcengine zxspectrum psp n64 psx nds
do 
	echo $rom_folder
